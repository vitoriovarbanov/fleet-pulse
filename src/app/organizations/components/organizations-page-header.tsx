    ...
    return (
        ...
        >
            ...
            <div className="relative bg-gradient-to-br from-primary/10 via-secondary/5 to-transparent p-4 sm:p-6">
                ...
                <div className="absolute -bottom-20 right-1/3 w-48 h-48 bg-violet-500/5 rounded-full blur-3xl pointer-events-none" />

                {/* Decorative building silhouette */}
                <div className="absolute -right-8 -bottom-4 opacity-[0.03] pointer-events-none">
                    <Building2 className="h-48 w-48 sm:h-64 sm:w-64" strokeWidth={0.5} />
                </div>
                ...
                <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                    <div className="space-y-2">
                        ...
                        >
                            Manage organizations, create new accounts, and invite
                            fleet managers to the platform.
                        </motion.p>
                    </div>
