...
export function DriversEmptyState({
    ...
    return (
      ...
      >
        ...
        <p className="text-muted-foreground mb-6 max-w-sm">
          No drivers match your search for &quot;{searchQuery}&quot;. Try adjusting your
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-2xl font-bold mb-3">No drivers yet</h3>
        <p className="text-muted-foreground mb-8 max-w-md leading-relaxed">
          Get started by adding your first driver to the fleet. You&apos;ll be able to
          track their availability, assign vehicles, and manage their profiles.
        </p>
      ...
      >
        {[
          ...
          { icon: Sparkles, label: "Track availability" },
          { icon: Plus, label: "Assign vehicles" },
        ].map((feature, index) => (
          <motion.div
            key={feature.label}
            initial={{ opacity: 0, y: 10 }}
